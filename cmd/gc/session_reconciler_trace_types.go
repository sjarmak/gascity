...
const (
	...
	// TraceOutcomeSuspensionOverride marks a mode=always named session
	// draining despite live assigned work because it is blocked by rig or
	// city suspension (gc-2nq11): namedSessionSuspendedDrainOverridesAssignedWork
	// bypassed the usual assigned-work hold that would otherwise keep the
	// session open indefinitely.
	TraceOutcomeSuspensionOverride TraceOutcomeCode = "suspension_override"
