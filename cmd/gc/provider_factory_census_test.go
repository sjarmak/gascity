...
var canonicalProviderCalls = map[string]int{
	"cmd_beads_execution.go:newExecutionSessionLookup:newSessionProvider:bind-error":                                                           1,
	...
	"cmd_session.go:cmdSessionKillWithForce:newSessionProvider:bind-error":                                                                     1,
