 ...
 */
export const postV0CityByCityNameExtmsgOutboundFile = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameExtmsgOutboundFileData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameExtmsgOutboundFileResponses, PostV0CityByCityNameExtmsgOutboundFileErrors, ThrowOnError>({
