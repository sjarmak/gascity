...
func buildDesiredStateWithSessionBeadsAt(
	...
	if store != nil {
		...
		poolWorkBeads, poolWorkStoreRefs := filterAssignedWorkBeadsForPoolDemand(cfg, cityPath, store, sessionBeads.OpenInfos(), assignedWorkBeads, assignedWorkStoreRefs)
