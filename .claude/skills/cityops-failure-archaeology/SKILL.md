...
| 2026-06-24        | **All-day nudge hangs** — 4 orphaned `gc nudge poll` sidecars at ~735% CPU (gc-b9w88)                                                                                                                                                                    | `gc nudge` operations hang; poll procs >50% CPU (healthy is ~0%)                                                        | `nudge-poll-reaper` order, tightened to 2 m cadence 2026-06-29; durable fix held needs-source-impl                 | `orders/nudge-poll-reaper.toml` header                        |
...
- `idempotent = true` added to the four in-floor reapers (nudge-poll-reaper,
  ...
  `orders/nudge-poll-reaper.toml`; it documents why failing closed was a
