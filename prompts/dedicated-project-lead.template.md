...
| `codeprobe-pl` | `codeprobe` | `/home/ds/projects/codeprobe` |
...
| `enterprisebench-pl` | `enterprisebench` | `/home/ds/projects/EnterpriseBench` |
| `gascity-dashboard-pl` | `gascity-dashboard` | `/home/ds/gascity-dashboard` |
| `gascity-maintenance-pl` | `gascity` | `/home/ds/gascity` |
| `gascity-packs-pl` | `gascity-packs` | `/home/ds/gascity-packs-main` |
| `geo-pl` | `geo` | `/home/ds/projects/GEO` |
| `live-docs-pl` | `live_docs` | `/home/ds/projects/live_docs` |
| `mcp-ax-pl` | `mcp-ax` | `/home/ds/projects/mcp-ax` |
| `mem-pl` | `mem` | `/home/ds/projects/mem` |
| `migration-evals-pl` | `migration-evals` | `/home/ds/projects/migration-evals` |
| `scix-experiments-pl` | `scix-experiments` | `/home/ds/projects/scix_experiments` |
