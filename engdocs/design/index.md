...
| `durable-disarmed-work` | Proposed | Durable `gc.disarmed` do-not-execute semantics across claim, demand, wake, continuation, assignment, nudge, cache, and reconciliation paths |
