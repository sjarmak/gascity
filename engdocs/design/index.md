...
| `worktree-provenance-base-sha` | Implemented | `BaseSHA` names the commit a worktree provably descends from; `Verify` asserts ancestry instead of re-deriving the expected record from the observed one |
