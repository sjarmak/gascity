...
| `execview-execution-projection` | Proposed | `gc beads show --execution` read-only projection: workflow/step/session/worktree correlation, JSON shape, and stability contract |
