...
// DrainAckCancellationMetadataKeys returns the obsolete per-token
// cancellation marker keys present in metadata. Terminal session lifecycle
// writes use it to remove dynamic markers in the same update as fixed fields.
