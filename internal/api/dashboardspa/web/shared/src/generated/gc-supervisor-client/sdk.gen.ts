...
/**
 * Post v0 city by city name mail delivery reconcile seat
 */
export const postV0CityByCityNameMailDeliveryReconcileSeat = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameMailDeliveryReconcileSeatData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameMailDeliveryReconcileSeatResponses, PostV0CityByCityNameMailDeliveryReconcileSeatErrors, ThrowOnError>({
...
/**
 * Get v0 city by city name mail delivery by attempt ID
 */
export const getV0CityByCityNameMailDeliveryByAttemptId = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameMailDeliveryByAttemptIdData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameMailDeliveryByAttemptIdResponses, GetV0CityByCityNameMailDeliveryByAttemptIdErrors, ThrowOnError>({ url: '/v0/city/{cityName}/mail/delivery/{attemptID}', ...options });

/**
 * Post v0 city by city name mail delivery by attempt ID invoke
 */
export const postV0CityByCityNameMailDeliveryByAttemptIdInvoke = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameMailDeliveryByAttemptIdInvokeData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameMailDeliveryByAttemptIdInvokeResponses, PostV0CityByCityNameMailDeliveryByAttemptIdInvokeErrors, ThrowOnError>({ url: '/v0/city/{cityName}/mail/delivery/{attemptID}/invoke', ...options });

/**
 * Post v0 city by city name mail durable
 */
export const postV0CityByCityNameMailDurable = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameMailDurableData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameMailDurableResponses, PostV0CityByCityNameMailDurableErrors, ThrowOnError>({
