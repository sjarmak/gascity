...
/**
 * Post v0 city by city name temporal fenced executions cancel
 */
export const postV0CityByCityNameTemporalFencedExecutionsCancel = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameTemporalFencedExecutionsCancelData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameTemporalFencedExecutionsCancelResponses, PostV0CityByCityNameTemporalFencedExecutionsCancelErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name temporal fenced executions execute
 */
export const postV0CityByCityNameTemporalFencedExecutionsExecute = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameTemporalFencedExecutionsExecuteData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameTemporalFencedExecutionsExecuteResponses, PostV0CityByCityNameTemporalFencedExecutionsExecuteErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name temporal fenced executions resolve
 */
export const postV0CityByCityNameTemporalFencedExecutionsResolve = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameTemporalFencedExecutionsResolveData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameTemporalFencedExecutionsResolveResponses, PostV0CityByCityNameTemporalFencedExecutionsResolveErrors, ThrowOnError>({
